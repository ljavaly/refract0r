                            ...
                            >
                                ...
                                <div className="conversation-details">
                                    <div className="conversation-name">
                                        {conv.name}
                                        {conv.isGroup && (
                                            <span className="ml-1 text-xs text-gray-400">({conv.participants})</span>
                                        )}
                                    </div>
                ...
                <div className="main-content">
                    <div className="main-content-header">
                        <div>
                            ...
                            {activeConversation && conversations.find(c => c.id === activeConversation)?.isGroup && (
                                <span className="main-content-subtitle">
                                    {conversations.find(c => c.id === activeConversation)?.participants} participants
                                </span>
                            )}
                        </div>
                                ...
                                <div key={message.id} className="message-item">
                                    {(() => {
                                        ...
                                        return (
                                            <>
                                                {avatar ? (
                                                    <img src={avatar} alt={`${message.user} Avatar`} className="message-avatar-small" />
                                                ) : (
